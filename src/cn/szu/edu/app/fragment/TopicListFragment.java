...
import cn.szu.edu.app.adapter.TopicListAdapter;
 ...
 */
public class TopicListFragment extends BaseListFragment<Tweet> implements
        OnItemLongClickListener, OnTabReselectListener {

    protected static final String TAG = TopicListFragment.class.getSimpleName();
