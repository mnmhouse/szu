...
public class ServerTaskService extends IntentService {
    ...
    public static final String ACTION_PUB_BLOG_COMMENT = "cn.szu.edu.app.ACTION_PUB_BLOG_COMMENT";
    public static final String ACTION_PUB_COMMENT = "cn.szu.edu.app.ACTION_PUB_COMMENT";
    public static final String ACTION_PUB_POST = "cn.szu.edu.app.ACTION_PUB_POST";
    public static final String ACTION_PUB_TWEET = "cn.szu.edu.app.ACTION_PUB_TWEET";
    public static final String ACTION_PUB_SOFTWARE_TWEET = "cn.szu.edu.app.ACTION_PUB_SOFTWARE_TWEET";
